...
Note: Raw dataset was too massive for upload. Use link to website to get data. However, it is a LIVE dataset that is constantly being updated. Therefore, the results that you will run with the new dataset will produce different results then what I have. To confirm reproducibility, I manually pulled the raw data out of PostgreSQl and reproduced the data via a CSV format on my own device. Massive limitation!
